...
➡️ Untuk sekarang bot dalam status pay to add ( Sewa ).
...
⚠️ Segala kebijakan dan ketentuan Ameliabot di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user(*﹏*) 

Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan Ameliabot
😖🙏
`
}
exports.welcome = () =>{
